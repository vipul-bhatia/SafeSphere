      ...
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            Empowering small businesses for data compliance excellence. Simplify your compliance journey with SafeSphere. Navigate policies seamlessly. Trust us to ensure your business meets data compliance effortlessly.
            </div>
